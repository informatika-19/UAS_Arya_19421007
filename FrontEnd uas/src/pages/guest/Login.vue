<template>
    <q-layout class="bg-blue-grey-1" view="LHh Lpr Lff">
        <q-page-container>
            <q-page padding class="row items-center justify-center bg-grey-1">
                <div class="row full-width">
                   <div class="col-md-8 offset-md-2 col-xs-12 q-pa-md bg-grey-14">
                       <q-card flat class="text-blue-grey-14">
                         <div class="row items-center">
                           <div class="col-md-6 col-sm-col-xs-12">
                               <div class="row q-pt-md q-pb-md">
                                   <div class="col-md-8 offset-2">
                                     <q-img src="https://www.golag.ph/ola/wp-content/uploads/2018/12/TopUp_670x670._V511323705_.png"></q-img>
                                   </div>
                               </div>
                            </div>
                ...
                <div class="col-mg-6">
                  <q-card-section>
                  <div class="text-h3">Topup & joki app</div>
